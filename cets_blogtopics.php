 ...
 */
   ...
   // Adds or updates the blog topic, whichever is necessary
	...
	function add_siteadmin_page(){
      if (is_site_admin()) {
        add_submenu_page('wpmu-admin.php', 'Blog Topics Management', 'Blog Topics Management', 10, 'cets_bc_management_page', array(&$this, 'cets_bc_management_page'));
      }
	 }
	 ...
	 function cets_bc_management_page(){
        ...
        <h2>Update/Add Blog Topics</h2>
			...
			<div>
				...
				$featured = $this->get_featured_topic();
				 $this->get_topics_select($featured); ?> <input type="submit" value="Set Featured Topic">
		...
		<p><a href="wpmu-admin.php?page=cets_bc_management_page&uninstalling=true">Yes, uninstall this plugin.</a>
